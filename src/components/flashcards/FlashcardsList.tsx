...
export function FlashcardsList() {
  ...
  return (
    <>
      {successMessage && (
        <div
          className="mb-4 rounded-xl border border-fuchsia-300/60 bg-fuchsia-400/10 p-3 shadow-[0_0_40px_-20px_rgba(236,72,153,0.6)]"
          data-test-id="flashcard-deleted-message"
        >
